...
import { formatAmount, formatUsd, formatBps, formatHealthFactor } from "../../lib/api-client";
    ...
    <div className="border border-tactical-border bg-tactical-surface mt-2">
      ...
      <div className="p-3">
        <div className="grid grid-cols-2 gap-x-6 gap-y-2 text-[11px] mb-3">
          ...
          <div className="text-[#888]">Max Borrow</div>
        ...
        <div className="border-t border-tactical-border pt-3">
          <div className="text-[9px] text-tactical-dim uppercase tracking-wider mb-2">Select Amount</div>
